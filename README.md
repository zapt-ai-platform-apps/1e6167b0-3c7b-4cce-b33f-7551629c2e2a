...
14. [استخدام لوحة تحكم المشرف](docs/journeys/admin-dashboard.md) - إدارة المدونة.
...
- تم إضافة زر **طلب الخدمة** في صفحة الخدمات لتمكين المستخدمين من إرسال طلبات الحصول على الخدمات بسهولة.
