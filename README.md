...
18. [استخدام منشئ السيرة الذاتية الذكي](docs/journeys/use-smart-cv-generator.md) - أنشئ سيرة ذاتية احترافية بتنسيق ومظهر جذاب.
19. [مشاركة التطبيق](docs/journeys/share-the-app.md) - شارك التطبيق مع الآخرين واكتشف المزيد من التفاصيل
20. [طلب تطبيقك الخاص](docs/journeys/request-custom-app.md) - صمم تطبيقًا مخصصًا يلبي احتياجاتك الخاصة
...
- **جديد:** تمت إضافة أداة **منشئ السيرة الذاتية الذكي** تحت فئة **أدوات مساعدة بالذكاء الاصطناعي** لإنشاء سيرة ذاتية احترافية بتنسيق ومظهر جذاب.
- **جديد:** تمت إضافة خدمة **اطلب تطبيقك الخاص** تحت فئة **خدمات لأجلكم** لتصميم تطبيقات مخصصة تلبي احتياجاتك.
