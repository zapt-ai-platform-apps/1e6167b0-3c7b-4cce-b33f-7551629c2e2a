...
16. [استخدام أداة استخراج النص من الصورة](docs/journeys/use-image-text-extractor.md) - استخراج النصوص من الصور باستخدام الذكاء الاصطناعي.
...
- **OCR.space API**: نستخدم OCR.space لاستخراج النصوص من الصور في أداة استخراج النص من الصورة.
...
- `OCRSPACE_API_KEY`: Your OCR.space API Key for text extraction.
...
- تمت إضافة أداة **استخراج النص من الصورة** تحت فئة **أدوات إمكانية الوصول** لاستخراج النصوص من الصور باستخدام الذكاء الاصطناعي.
- تم تحديث ملف `package.json` لإضافة الاعتمادات الجديدة.
- تمت إضافة التوثيق اللازم للأداة الجديدة في قسم **كيفية استخدام التطبيق**.
