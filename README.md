...
7. [طلب خدمة](docs/journeys/request-service.md) - إرسال طلب للحصول على خدمة مجانية معينة.
...
- تم تعديل قسم الخدمات ليشمل **الخدمات المجانية** فقط، وتم إزالة الفئات الأخرى لتبسيط تجربة المستخدم.
