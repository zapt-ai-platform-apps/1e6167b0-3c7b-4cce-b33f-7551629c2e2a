...
12. [استكشاف المتجر والمنتدى](docs/journeys/explore-store-forum.md) - اكتشف المزيد من خلال أقسام المتجر والمنتدى.
13. [استخدام لوحة تحكم المشرف](docs/journeys/admin-dashboard.md) - إدارة المستخدمين، المدونة، المتجر، والمنتدى.
