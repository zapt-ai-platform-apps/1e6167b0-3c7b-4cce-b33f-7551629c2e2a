...
- **جديد:** تمت إضافة صفحة **انضم إلى الفريق** لتكون جزءًا من فريقنا والمساهمة في تطوير التطبيق.
- **جديد:** تمت إضافة صفحة **تقييم التطبيق** لمشاركة رأيك ومساعدتنا على تحسين التطبيق.