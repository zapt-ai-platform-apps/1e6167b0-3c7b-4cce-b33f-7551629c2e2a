...
function Services() {
  ...
  const categories = [
    ...
    },
    {
      name: 'خدمات الدعم',
      services: [
        { name: 'دعم فني', description: 'نقدم دعمًا فنيًا لحل المشكلات التقنية التي تواجهك.' },
        { name: 'توفير أجهزة مساعدة', description: 'نقدم أجهزة مساعدة للمحتاجين بأسعار مخفضة.' },
      ],
    },
  ];
