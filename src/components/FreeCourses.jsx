...
function FreeCourses() {
  const [courses] = createSignal([
    ...
    {
      name: 'ابدأ مشوار العمل والكسب من خلال الإنترنت',
      description: 'ابدأ رحلتك في العمل والكسب من خلال الإنترنت وتعرّف على الأدوات والمهارات اللازمة لتحقيق النجاح عبر الإنترنت.',
    },
  ]);
