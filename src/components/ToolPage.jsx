      ...
      <Routes>
        <Route path="/" element={
          <>
            ...
            {toolName === 'pdf-summarizer' && <PDFSummarizer />}
            {!(toolName in {'chat-assistant':1,'smart-writing-assistant':1,'smart-voice-assistant':1,'arabic-radio':1,'article-generator':1,'image-generator':1,'website-builder':1,'cv-generator':1,'pdf-summarizer':1}) && (
