const categories = [
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'قارئ PDF الاحترافي', description: 'استخدم تقنية OCR والذكاء الاصطناعي لقراءة ملفات PDF وعرض النصوص المنسقة.' },
      { name: 'أداة وصف الصورة', description: 'احصل على وصف دقيق ومفصل لأي صورة باستخدام الذكاء الاصطناعي.' },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      { name: 'أداة تجربة الأكواد البرمجية', description: 'جرب الأكواد البرمجية HTML وCSS وJS مباشرة وشاهد النتائج.' },
    ],
  },
];
