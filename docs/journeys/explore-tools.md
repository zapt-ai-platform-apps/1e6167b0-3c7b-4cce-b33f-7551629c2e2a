...
4. **استكشاف الأدوات في الفئة المحددة**:
   ...
   - الأدوات المتاحة حاليًا في فئة **أدوات مساعدة بالذكاء الاصطناعي**:
     ...
     - **المساعد الصوتي الذكي**: تفاعل صوتيًا مع المساعد للحصول على إجابات فورية ومساعدة فورية.
...
6. **استخدام الأداة**:
   ...
   - على سبيل المثال، في **المساعد الصوتي الذكي**:
     - اضغط على زر **تحدث** وابدأ في التحدث.
     - انتظر رد المساعد الصوتي الذكي واستمع إلى الإجابة.
